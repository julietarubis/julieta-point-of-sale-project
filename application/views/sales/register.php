...
else
{
	...
	?>
		...
		<td><?php echo to_currency($item['price']*$item['quantity']*(100/112)); ?></td>
	...
	?>
		...
		?>
			<div id="finish_sale">
				...
				<br />-->
				<br />
				<label id="comment_label" for="comment"><?php echo $this->lang->line('common_take_type'); ?>:</label>
				<?php echo form_textarea(array('name'=>'take_type', 'id' => 'take_type', 'value'=>$take_type,'rows'=>'4','cols'=>'23'));?>
				<br />
				<label id="comment_label" for="comment"><?php echo $this->lang->line('common_senior'); ?>:</label>
				<?php echo form_textarea(array('name'=>'senior', 'id' => 'senior', 'value'=>$senior,'rows'=>'4','cols'=>'23'));?>
				<br />
				<!--<br />
				<label id="comment_label" for="comment"><?php //echo $this->lang->line('common_senior_details'); ?>:</label>
				<?php //echo form_textarea(array('name'=>'senior_details', 'id' => 'senior_details', 'value'=>$senior_details,'rows'=>'4','cols'=>'23'));?>
				<br /><br />-->
				<br /><br />
...
$(document).ready(function()
{
	...
	{
		$.post('<?php echo site_url("sales/set_senior");?>', {senior: $('#senior').val()});
	});
	
	$('#take_type').change(function() 
	{
		$.post('<?php echo site_url("sales/set_take_type");?>', {take_type: $('#take_type').val()});
	});
	
	/*$('#senior_details').change(function() 
	{
		$.post('<?php echo site_url("sales/set_senior_details");?>', {senior_details: $('#senior_details').val()});
	});*/
