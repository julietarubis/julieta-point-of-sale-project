...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_take_type').':', 'take_type'); ?>
	<div class='form_field'>
	<?php echo form_textarea(array(
		'name'=>'take_type',
		'id'=>'take_type',
		'value'=>$person_info->take_type,
		'rows'=>'5',
		'cols'=>'17')		
	);?>
	</div>
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_senior').':', 'senior'); ?>
	<div class='form_field'>
	<?php echo form_textarea(array(
		'name'=>'senior',
		'id'=>'senior',
		'value'=>$person_info->senior,
		'rows'=>'5',
		'cols'=>'17')		
	);?>
	</div>
...
<!--<div class="field_row clearfix">	
<?php //echo form_label($this->lang->line('common_senior_details').':', 'senior_details'); ?>
	<div class='form_field'>
	<?php /*echo form_textarea(array(
		'name'=>'senior_details',
		'id'=>'senior_details',
		'value'=>$person_info->senior_details,
		'rows'=>'5',
		'cols'=>'17')		
	);*/?>
	</div>
