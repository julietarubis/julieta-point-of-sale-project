...
<th style="width:11%;"><?php echo $this->lang->line('sales_service_charge'); ?></th>
...
else
{
	...
	?>
		...
		<?php
        	...
        	{
        		//echo $item['quantity'];
        		echo form_input(array('name'=>'quantity','value'=>$item['quantity'],'size'=>'6'));
        	}
        	else
        	{
		...
		<td><?php echo form_input(array('name'=>'service_charge','value'=>$item['service_charge'],'size'=>'3'));?></td>
...
<div id="overall_sale">
    ...
    <table width="100%">
	<!--<tr>
    <td style="width:55%; "><div class="float_left"><?php //echo 'Service Charge:' ?></div></td>
    <td style="width:45%; text-align:right;"><div class="float_left" style="text-align:right;font-weight:bold;"><?php //echo to_currency($service_charge); ?></div></td>
	</tr>-->
	<tr>
...
$(document).ready(function()
{
	...
	{
		$.post('<?php echo site_url("sales/set_service_charge");?>', {service_charge: $('#service_charge').val()});
	});
