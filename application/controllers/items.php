...
/**END GARRISON ADDED**/
	...
	function save($item_id=-1)
	{
		...
		if($this->Item->save($item_data,$item_id))
		{
			...
			(
				...
				'trans_senior'=>$this->lang->line('items_manually_editing_of_quantity'),
				'trans_take_type'=>$this->lang->line('items_manually_editing_of_quantity'),
	...
	{	
		...
		(
			...
			'trans_senior'=>$this->input->post('trans_senior'),
			'trans_take_type'=>$this->input->post('trans_take_type'),
				...
				while (($data = fgetcsv($handle)) !== FALSE)
				{
					...
					if($this->Item->save($item_data)) 
					{
						...
						if(count($items_taxes_data) > 0)
						{
							...
							$senior ='Qty CSV Imported';
							$take_type ='Qty CSV Imported';
							$excel_data = array
								(
